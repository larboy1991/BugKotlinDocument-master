...
val isAlwaysShowAuthor
	get() = globalSettings.alwaysShowAuthor

val author
	get() = globalSettings.author

val isAlwaysCompany
	 get() = globalSettings.alwaysShowCompany

val company
	 get() = globalSettings.company
...
val isKotlinNative
	get() = PlatformUtils.isAppCode() || PlatformUtils.isCLion() || PlatformUtils.isIntelliJ()